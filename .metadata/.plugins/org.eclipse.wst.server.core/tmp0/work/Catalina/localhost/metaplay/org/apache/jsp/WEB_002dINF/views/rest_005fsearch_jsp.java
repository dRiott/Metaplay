 ...
 * Generated at: 2015-10-14 19:37:17 UTC
...
public final class rest_005fsearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t$.ajax({\n");
      out.write("\t        url: \"/metaplay/rest/artist\",\n");
      ...
      out.write("\t\t\tconsole.log(\"in success JSON\");\n");
      ...
      out.write("\t        console.log(\"in getMYName\");\n");
      out.write("\t\t\t$.ajax({\n");
      out.write("\t\t        url: \"/metaplay/rest/artist/?id=\"+countTEXT, \n");
      out.write("\t\t        method: \"get\", \n");
      ...
      out.write("\t\t\tconsole.log(\"in success TEXT\");\n");
      out.write("\t\t\t$('#hello').html(\"I am \" + returnedData.name);\n");
      out.write("\t\t}\n");
      out.write("\t\n");
      out.write("/// ************** *************** Event Handlers ************** ************** ***********\n");
      out.write("\t\t\t$('#button').click(function() {\n");
      out.write("\t\t        console.log(\"in button\");\n");
      out.write("\t\t\t\tgetMyName();\n");
      out.write("\t\t    });\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t$('#button2').click(function() {\n");
      out.write("\t\t        console.log(\"in button2\");\n");
      out.write("\t\t        console.log(json);\n");
      out.write(" \t\t\t\t$('#hello2').html(\"Hello my name is \" + json.name + \" \" + json.id);\n");
      out.write(" \t   \t\t\tcountJSON++;\n");
      out.write("\t\t\t});\t\n");
      out.write("\t\t});\n");
      out.write("\t\t\n");
      ...
      out.write(" \t <div id=\"searchSpace\">Search Space</div><br/>\n");
      out.write(" \t <input id=\"searchInput\" type=\"text\" placeholder=\"Search for Artists, Albums, Tracks...\"/>\n");
      out.write("\t</form>\n");
      out.write("</body>\n");
      out.write("</html>");
