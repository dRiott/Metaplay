...
<%-- 				<div class="form-group">
				...
				<div class="form-group">
					...
					<form:input path="genreName" cssClass="form-control" value="Pop/Rock" id="genre-name" />
				</div>
				
				<div class="form-group">
					<label for="location-city">City</label> 
					<form:input path="locationCity" cssClass="form-control" value="Denver" id="location-city" />
				</div>

				<div class="form-group">
					<label for="location-state">State</label> 
					<form:input path="locationState" cssClass="form-control" value="Colorado" id="location-state" />
				</div>
				
				<div class="form-group">
					<label for="recordLabel-name">Record Label</label> 
					<form:input path="recordLabelName" cssClass="form-control" value="Paw Tracks" id="recordLabel-name" />
				</div>
		...
		<!--  Album fields here -->
				<div class="form-group">
					...
					<form:input path="albumName" cssClass="form-control" id="album-name" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<form:input path="albumReleaseDate" cssClass="form-control" id="album-releaseDate" />
				</div>
				<div class="form-group">
					<label for="album-albumCover">Album: Album Cover</label>
					<form:input path="albumAlbumCover" cssClass="form-control" id="album-albumCover" />
				</div>
		<!--  End Album fields -->
