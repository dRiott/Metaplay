...
<nav class="navbar navbar-default">
	...
	<!-- Home -->
			<li><a href="/metaplay/home">Home</a></li>
	...
	<!-- Login Page -->
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<ul class="dropdown-menu" role="menu">
					<li><a href="<spring:url value="/user/add"/>">New User? Start here!</a></li>
					<li><a href="<spring:url value="/user/login"/>">Login Ya Noggin'</a></li>
					<li><a href="<spring:url value="/user/byebye"/>">I Go Bye Bye</a></li>
				</ul></li>
