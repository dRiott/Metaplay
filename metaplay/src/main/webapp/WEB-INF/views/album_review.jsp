		...
		<form:form action="${thisURL}" method="post" modelAttribute="createAlbumWrapper">
			...
			<div class="row">
				...
				<div class="form-group">
					<label>* Album Name</label> <span class="dSpan">${createAlbumWrapper.name}</span>
				</div>
			...
			<!-- START Record Label fields here -->
				<div class="form-group">
					...
					<c:if test="${createAlbumWrapper.recordLabelFromList.contains('** New Record Label **')}">
						<div class="form-group">
							<label><em>New Record Label: Name</em></label>
							<c:out value="${createAlbumWrapper.theNewRecordLabel}"/>
						</div>
						<div class="form-group">
							<label><em>New Record Label: City</em></label>
							<c:out value="${createAlbumWrapper.recordLabelCity}"/>
						</div>
						<div class="form-group">
							<label><em>New Record Label: State</em></label>
				...
				<div class="form-group">
					<label>Release Date</label> <span class="dSpan">${createAlbumWrapper.releaseDate}</span>
				</div>
				
				<div class="form-group">
					<label>* Minutes</label> <span class="dSpan">${createAlbumWrapper.lengthMinutes}</span>
				</div>
				<div class="form-group">
					<label>* Seconds</label> <span class="dSpan">${createAlbumWrapper.lengthSeconds}</span>
				</div>
				
				<label for="albumTracks">Tracks</label><br/>
				<table width="650" border="1" cellPadding="3" cellSpacing="0" id="albumTracks">
